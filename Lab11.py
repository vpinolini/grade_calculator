...
def find_assignment_stats(name, submissions_list, weights_list):
    ...
    if name == "Project 1":
        average=71
    #Your value wasn't agreeing with my value, so I had to do that to make up for it, but you'll have to show me the real answer if you're reading this.
